...
/*   Updated: 2026/05/14 15:48:51 by moerrais         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void *coders_routine(void *arg)
{
	...
	coder = (t_coder *)arg;	
	pthread_mutex_lock(&coder->monitor_lock->mutex);
	(*coder->run_coders_counter)++;
	pthread_cond_broadcast(&coder->monitor_lock->cond);
	pthread_mutex_unlock(&coder->monitor_lock->mutex);
